...
Copy the markdown table code below into your assignment file to help you summarize your findings. Then write a paragraph that summarizes your results. Which statistic would you recommend if estimating $\lambda$? Compare the different measures of center with respect to the accuracy and bias. Use complete sentences.
