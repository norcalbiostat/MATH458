...
* Error Assessment available for the midterm. 

:::{.callout-tip}
#### Error Assessment
For the midterm you will have an opportunity assess your errors on the midterm, make corrections, review the corrections with me, for a partial return of the credit lost. You must do the following steps to receive this credit - 

-   Download the [Error Assessment Form](notes/Analyzing%20exam%20errors.pdf)
-   Review the six types of test taking errors.
