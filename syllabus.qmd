...
> Automatic half credit will be applied to any assignment submitted after the solutions are posted. This includes homework, worksheets, and the course notes. 
...
#### Applied Project (20%)
* Details are in development, but the overall goal will be for you to identify something that you are interested in researching, design a data collection tool & method, collect and analyze the desired data, and report your findings. 
...
* Either directly, or through HackMD I will provide you the code that created those notes, with selected omissions that you are responsible for filling out during and after class.
