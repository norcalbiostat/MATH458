...
Your final grade will be a straight sum of points earned and will be displayed as a running total in Canvas.  I use a standard grade cutoff of 100-90%: A, 89-80%: B, 79-70%: C, 69-60%: D, 0-59%: F  


#### Exams (40%)
* 2 Exams (midterm/final, not cumulative). [Error Assessment Form](notes/Analyzing exam errors.pdf) available for the midterm. 

#### Homework Assignments (25%)
* Written homework assignments on the topics listed above. 
...
#### Notes (10%)
* The course notes are available on the class website (not Canvas). What is presented in class will be incomplete, and we will work through them during class. 
* I will provide you with a copy of the Quarto `.qmd` script file that created those notes, that have selected omissions that you are responsible for filling out in, and after class.
...
* If you miss a day, or miss something in a lecture, or don't get to finish all the "you try it" questions it is up to you to check with a classmate and/or the online course notes to complete all entries before submission.
