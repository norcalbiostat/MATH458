...
$$
write the equation here. the dollar signs indicate the start & end of a math equation block
$$
...
### Example: 
```{r}
sample(1:6, size=5) # ________
sample(1:6, size=5, replace=____) # ________
```
