...
_[HackMD notes](https://hackmd.io/@norcalbiostat/cn02-intro_sampling)_
...
In [the HackMD notes](https://hackmd.io/@norcalbiostat/cn02-intro_sampling), summarize briefly and provide a unique example (that is, not the one in the text) for the type of selection bias that you are assigned to review. Be prepared to share this out with the class. 

:::

> After class be sure to add all examples from your classmates to your notes. Clean them up as needed. 
...
* **Title w/ URL**: [National survey shows majority of Americans polled support freedom to choose dogs, regardless of breed](
https://www.prweb.com/releases/2014/01/prweb11519175.htm)  
* **Stated Population**: All Americans  
* **Statistic being estimated** 84 percent of those polled believe that local, state or federal governments should not infringe on a person’s right to own whatever breed of dog they choose.   
* **Margin of Error**: The results of the survey have a margin of error of +/- 3.4 percent.
