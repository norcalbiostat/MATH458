...
* (Caleb) People may have incorrect information influencing their response. For example, people may not actually know their ethnic background, only what their parents have told them. 
* (Caleb) People might just lie for fun, like putting that they're a 100 year old bazillionaire in a questionnaire. 
...
* (Quinten) They don't like the interviewer
* (Quinten) The question is too loaded
...
:::{.callout-tip}
### Cluster sample
Divide population into clusters where clusters are similar to each other. Then measure _all_ units in the cluster. 
