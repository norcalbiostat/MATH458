...
sampling.frame <- googlesheets4::read_sheet(frame.url) |> janitor::clean_names()
```
...
```{r}
set.seed(12345)
srs.idx <- sampling::srswor(150, NROW(sampling.frame))
alumni.srs <- getdata(sampling.frame, srs.idx)
```
...
p.1 <- sum(strata2.frame$expected_grad_year==2015)/299*(150)
p.2 <- sum(strata2.frame$expected_grad_year==2016)/299*(150)
p.3 <- sum(strata2.frame$expected_grad_year==2017)/299*(150)
p.4 <- sum(strata2.frame$expected_grad_year==2018)/299*(150)
p.5 <- sum(strata2.frame$expected_grad_year==2019)/299*(150)
p.6 <- sum(strata2.frame$expected_grad_year==2020)/299*(150)
p.7 <- sum(strata2.frame$expected_grad_year==2021)/299*(150)
p.8 <- sum(strata2.frame$expected_grad_year==2022)/299*(150)
p.9 <- sum(strata2.frame$expected_grad_year==2023)/299*(150)
p.10 <- (sum(strata2.frame$expected_grad_year==2024)/299)*(150)

alloc<- c(p.1, p.2,p.3,p.4,p.5,p.6,p.7,p.8,p.9,p.10)
...
```{r, eval=FALSE}
sampling.frame$SRS <- ifelse(sampling.frame$FIXED_ID %in%
                                        alumni.srs$FIXED_ID, 1, 0)
